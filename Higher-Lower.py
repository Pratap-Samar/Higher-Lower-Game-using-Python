...
#welcome and rules
print("welcome to the Higher-Lower game By Samar \nrule of the games are: \nThe computer will give you random number and \nYou will have to guess if the next will be higher or lower than the given number\nAfter each correct guess you get 5 points and the game ends after one wrong guess\n\n\n")
